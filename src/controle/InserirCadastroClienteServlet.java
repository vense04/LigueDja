...
public class InserirCadastroClienteServlet extends HttpServlet {
	...
	private Usuario instanciar(HttpServletRequest req) throws ParseException {
		...
		try {
			...
			usuar.setConSenha(auxiliar); esse campo tem apenas no formulario mas n�o tem no banco--verificar se tem a necessidade
			talvez fazer uma javaScript para comparar se os dois campos s�o iguais
			*/
